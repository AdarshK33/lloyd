...
function KYC() {
  ...
  const validators: Record<string, (val: any) => string> = {
    ...
    panCard: (val) => {
      ...
      if (!/[0-9]{4}[A-Z]$/.test(val))
        return "**Last must be 4 digits + 1 capital letter";
        ...
        <div className={styles.formSection}>
          <form onSubmit={handleSubmit} className="form">
            ...
            {panForm ? (
              <>
                ...
                <div className={styles.inputGroup}>
                  ...
                  {errors.file3 && <p className="validation">{errors.file3}</p>}
                </div>
              </>
            ) : (
              <></>
            ...
            <div className={styles.inputGroup}>
              ...
              {errors.file1 && <p className="validation">{errors.file1}</p>}
            </div>
            ...
            <div className={styles.inputGroup}>
              ...
              {errors.file2 && <p className="validation">{errors.file2}</p>}
            </div>
