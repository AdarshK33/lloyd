...
export const { setAccessToken, clearAccessDetails, setUserKey , setMobile,setReward} =
  authSlice.actions;

// Selectors returned by `slice.selectors` take the root state as their first argument.
export const { getAccessDetails, getAccessToken,  getMobile,getReward} = authSlice.selectors;
