...
const RegistrationStep1 = lazy(() => import("./pages/registration/RegistrationStep1"));
const RegistrationStep2 = lazy(() => import("./pages/registration/RegistrationStep2"));
const VerificationOtp = lazy(() => import("./pages/verificationOtp/VerificationOtp"));
